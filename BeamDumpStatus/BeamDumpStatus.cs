...
namespace BeamDump
{
    public static class BeamDumpStatus
    {
        ...
        private static bool CheckIQCIndividual(Machine.Beam beam)
        {
            switch (beam)
            {
                case Machine.Beam.Beam1:
        ...
        private static bool CheckIPOCInjectionPaneIndividual(Machine.Beam beam)
        {
            switch (beam)
            {
                case Machine.Beam.Beam1:
        ...
        private static bool CheckTimeoutIndividual(Machine.Beam beam)
        {
            switch (beam)
            {
                case Machine.Beam.Beam1:
        ...
        private static bool CheckRemoteInjectionPaneIndividual(Machine.Beam beam)
        {
            switch (beam)
            {
                case Machine.Beam.Beam1:
        ...
        private static bool CheckONBeamDumpPaneIndividual(Machine.Beam beam)
        {
            switch (beam)
            {
                case Machine.Beam.Beam1:
        ...
        private static bool CheckXPOCIndividual(Machine.Beam beam)
        {
            switch (beam)
            {
                case Machine.Beam.Beam1:
        ...
        private static bool CheckLASSIndividual(Machine.Beam beam)
        {
            switch (beam)
            {
                case Machine.Beam.Beam1:
        ...
        private static bool CheckBETSIndividual(Machine.Beam beam)
        {
            switch (beam)
            {
                case Machine.Beam.Beam1:
